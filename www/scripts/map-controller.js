...
var loadMap = function() {
  ...
  $.getJSON("http://192.168.0.110/map/routes.json",
  // $.getJSON("http://localhost:5000/map/routes.json",
            function(routes) {
  ...
  $.getJSON("http://192.168.0.110:5000/map/business.json",
  // $.getJSON("http://localhost:5000/map/business.json",
            function(business) {
...
$.getJSON("http://192.168.0.110:5000/map/affiliations.json",
